...
class Home extends Component<Props, State> {
  ...
  renderMainContent = (data: HomeRequestResult): Object => {
    ...
    const hasYouMightLikeDishes =
      youMightLikeDishes && youMightLikeDishes.length > 0;
    ...
    return (
      <ScrollView
        ...
        {hasInYourCityEvents && (
          <Section nextRoute={ROUTE_NAMES.SEE_ALL_EVENTS} title="In Your City">
            <InYourCitySection events={inYourCityEvents} />
          </Section>
        )}
        {hasYouMightLikeDishes && (
          <Section
            ...
            <YouMightLikeSection dishes={youMightLikeDishes} />
          </Section>
        )}
        {hasPopularDishes && (
          <Section nextRoute={ROUTE_NAMES.POPULAR_SEE_ALL} title="Popular">
            <PopularSection dishes={popularDishes} />
          </Section>
        )}
      </ScrollView>
    );
